...
public class CompanyServiceImpl implements CompanyService {
    ...
    public List<CompanyDto> getAllCompanies() {
        try {
            ...
            logger.error("Failed to retrieve companies (HTTP 500): {}",
    ...
    public CompanyDto getCompanyById(Long id) {
        ...
        try {
            ...
            logger.error("Company not found for ID [{}] (HTTP 404): {}",
                    id, e.getMessage(), new HttpStatusException(404));
            throw new HttpStatusException(404);
        } catch (Exception e) {
            logger.error("Failed to retrieve company ID [{}] (HTTP 500): {}",
    ...
    public CompanyDto createCompany(CompanyDto companyDto) {
        ...
        try {
            ...
            logger.error("Failed to create company [{}] (HTTP 500): {}",
                    companyDto.getName(), e.getMessage(), new HttpStatusException(500));
            throw new HttpStatusException(500);
        }
    }
    ...
    public CompanyDto updateCompany(Long id, CompanyDto companyDto) {
        ...
        try {
            ...
            logger.error("Failed to update company ID [{}] (HTTP 500): {}",
                    id, e.getMessage(), new HttpStatusException(500));
            throw new HttpStatusException(500);
        }
    }
    ...
    public void deleteCompany(Long id) {
        ...
        try {
            ...
            logger.error("Failed to delete company ID [{}] (HTTP 500): {}",
                    id, e.getMessage(), new HttpStatusException(500));
            throw new HttpStatusException(500);
        }
    }
    ...
    @Override
    public List<EmployeeDto> findEmployeesByDepartment(Long companyId,
                                                       String departmentName) {
        if (companyId == null || departmentName == null || departmentName
                .isEmpty()) {
            logger.error("Find employees by department failed (HTTP 400): "
                    + "Company ID or department name is null/empty", new HttpStatusException(400));
            throw new HttpStatusException(400);
        }
        try {
            ...
            List<EmployeeDto> result = employees.stream()
                    ...
                    .toList();
            logger.info("Retrieved employees for company ID [{}] and "
                    + "department [{}]: {} found", companyId, departmentName,
                    result.size());
            return result;
        } catch (Exception e) {
            logger.error("Failed to retrieve employees for company ID [{}] "
                    + "and department [{}] (HTTP 500): {}", companyId, departmentName,
                    e.getMessage(), new HttpStatusException(500));
            throw new HttpStatusException(500);
        }
    }
    ...
    @Override
    public List<CompanyDto> findCompaniesWithHighSalaryEmployeesNative(
            BigDecimal salary) {
        if (salary == null) {
            logger.error("Find companies with high salary employees failed"
                    + " (HTTP 400): Salary is null", new HttpStatusException(400));
            throw new HttpStatusException(400);
        }
        try {
            ...
            List<CompanyDto> result = companies.stream()
                    ...
                    .toList();
            logger.info("Retrieved companies with high salary employees"
                    + " (>{}): {} found", salary, result.size());
            return result;
        } catch (Exception e) {
            logger.error("Failed to retrieve companies with high "
                    + "salary employees (>{}) (HTTP 500): {}", salary, e.getMessage(),
                    new HttpStatusException(500));
            throw new HttpStatusException(500);
        }
    }
