...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    public List<DepartmentDto> getAllDepartments() {
        try {
            ...
            logger.error("Failed to retrieve departments (HTTP 500): {}",
    ...
    public DepartmentDto getDepartmentById(Long id) {
        ...
        try {
            ...
            logger.error("Department not found for ID [{}] (HTTP 404): {}",
                    id, e.getMessage(), new HttpStatusException(404));
            throw new HttpStatusException(404);
        } catch (Exception e) {
            logger.error("Failed to retrieve department ID [{}] (HTTP 500): {}",
    ...
    public DepartmentDto createDepartment(DepartmentDto departmentDto) {
        ...
        try {
            Department department = departmentMapper.toEntity(
                    departmentDto, companyRepository);
            Department savedDepartment = departmentRepository.save(department);
            DepartmentDto result = departmentMapper.toDto(savedDepartment);
            logger.info("Created department [{}]", result.getName());
            return result;
        } catch (EntityNotFound e) {
            logger.error("Entity not found for department [{}] (HTTP 404): {}",
                    departmentDto.getName(), e.getMessage(), new HttpStatusException(404));
            throw new HttpStatusException(404);
        } catch (Exception e) {
            logger.error("Failed to create department [{}] (HTTP 500): {}",
                    departmentDto.getName(), e.getMessage(), new HttpStatusException(500));
            throw new HttpStatusException(500);
        }
    }
    ...
    public DepartmentDto updateDepartment(Long id,
        ...
        try {
            ...
            Company company = companyRepository.findByName(updatedDepartmentDto.getCompany())
                    .orElseThrow(() -> new EntityNotFound(
                            "Company not found: " + updatedDepartmentDto.getCompany()));
            ...
            logger.error("Entity not found for department ID [{}] (HTTP 404): {}",
                    id, e.getMessage(), new HttpStatusException(404));
            throw new HttpStatusException(404);
        } catch (Exception e) {
            logger.error("Failed to update department ID [{}] (HTTP 500): {}",
                    id, e.getMessage(), new HttpStatusException(500));
            throw new HttpStatusException(500);
        }
    }
    ...
    public void deleteDepartment(Long id) {
        ...
        try {
            ...
            logger.error("Failed to delete department ID [{}] (HTTP 500): {}",
                    id, e.getMessage(), new HttpStatusException(500));
            throw new HttpStatusException(500);
        }
    }
